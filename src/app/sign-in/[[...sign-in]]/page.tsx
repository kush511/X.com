                    ...
                    <SignIn.Root >
                        ...
                        <SignIn.Step name="start">
                            <Clerk.Field name="identifier" className="flex flex-col gap-2">
                                ...
                                <Clerk.Input placeholder="email.." className="py-2 mt-3  px-6 rounded-full text-black bg-white w-72 placeholder:text-sm" />
                                <Clerk.FieldError className="text-red-300 text-sm" />
                            </Clerk.Field>
                            <SignIn.Action submit className="mt-2 w-72 py-2 flex items-center justify-center text-icon-blue text-sm underline text-center cursor-pointer">Continue</SignIn.Action>
                        </SignIn.Step>
                        ...
                        <SignIn.Step name="verifications">
                            <SignIn.Strategy name="password">
                                <Clerk.Field name="password" className="flex flex-col gap-2">
                                    ...
                                    <Clerk.Input placeholder="password" className="py-2 mt-3  px-6 rounded-full text-black bg-white w-72 placeholder:text-sm" />
                                    <Clerk.FieldError className="text-red-300 text-sm" />
                                </Clerk.Field>
                                <div className="flex flex-col gap-2">
                                    <SignIn.Action submit className="mt-2 w-72 py-2 flex items-center justify-center text-icon-blue text-sm underline text-center cursor-pointer">
                                        Continue

                                    </SignIn.Action>

                                    <SignIn.Action navigate="forgot-password" className="mt-2 w-72 py-2 flex items-center justify-center text-icon-blue text-sm underline text-center cursor-pointer">
                                        <div className="text-white decoration-white "> Forgot password?</div>
                            ...
                            <SignIn.Strategy name="reset_password_email_code">
                                ...
                                >We sent a code to <SignIn.SafeIdentifier /></p>
                                <Clerk.Field name="code" className="flex flex-col gap-2">

                                    <Clerk.Input placeholder="Verification Code"
                                        className="py-2 mt-3  px-6 rounded-full text-black bg-white w-72 placeholder:text-sm" />
                                    <Clerk.FieldError className="text-red-300 text-sm" />
                                </Clerk.Field>
                                <SignIn.Action submit className="mt-2 w-72 py-2 flex items-center justify-center text-icon-blue text-sm underline text-center cursor-pointer">
                                    Continue
                        ...
                        <SignIn.Step name="forgot-password" className="flex justify-between w-72 text-sm">
                            ...
                            <SignIn.SupportedStrategy name="reset_password_email_code">
                                <span className="underline text-icon-blue cursor-pointer mt-1">Reset password</span>
                            </SignIn.SupportedStrategy>
                            <SignIn.Action navigate="previous" className="underline cursor-pointer mt-1">Go back</SignIn.Action>
                        </SignIn.Step>
